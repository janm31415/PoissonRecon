...
extern PlyFile *poisson_ply_write(FILE *, int, const char **, int);
...
extern PlyFile *poisson_ply_read(FILE *, int *, char ***);
...
extern void poisson_ply_close(PlyFile *);
