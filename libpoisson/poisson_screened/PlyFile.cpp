							  ...
							  )
{
	...
	plyfile = poisson_ply_write (fp, nelems, elem_names, file_type);
	if (plyfile == NULL)
		return (NULL);
 ...
 ******************************************************************************/
 ...
 PlyFile *poisson_ply_read(FILE *fp, int *nelems, char ***elem_names)
 {
	 int i,j;
	 PlyFile *plyfile;
	 int nwords;
...
Open a polygon file for reading.
  ...
  ******************************************************************************/
	  ...
	  )
  {
	  ...
	  plyfile = poisson_ply_read (fp, nelems, elem_names);
...
//		  return;
  ...
  ******************************************************************************/
  ...
  void poisson_ply_close(PlyFile *plyfile)
  {
	  fclose (plyfile->fp);
